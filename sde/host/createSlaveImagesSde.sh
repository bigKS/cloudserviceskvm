...
function printUsageExit ()
{
	...
	echo
	echo "Usage:"
	echo "> $scriptName <path master image> <directory path slave images> <number 1 or 2 for dpi blade> <number of PTS images to create>"
	echo
	echo "Synopsis:"
...
# We want this to be run as root
(( $(id -u) == 0 )) || printErrorExit "This script must be run as root."
